...
public class TestUtilityFacadeImplementation implements BlFacade {

	TestUtilityDataAccess dbManager;
	...
	public TestUtilityFacadeImplementation()  {		
		...
		dbManager = new TestUtilityDataAccess(initialize);
		if (initialize)
			dbManager.initializeDB();
		dbManager.close();
	}

	public TestUtilityFacadeImplementation(TestUtilityDataAccess dam)  {
